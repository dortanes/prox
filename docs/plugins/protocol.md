...
!!! note "Windows"
    The stdin/stdout channel is available on Windows. The Unix socket channel is supported on Linux and macOS, so request-response hooks require one of those systems.
